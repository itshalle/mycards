...
draft: false
image: "images/blog/articles/what-is-dbt.webp"
image_alt: "چیدمان آرام ابزارهای روزمره برای نشان‌دادن مهارت‌های DBT"
---
...
ما در Only Cards هم اولین دک مهارت‌های زندگی را با ذهن‌آگاهی شروع کرده‌ایم. این مجموعه هنوز در حال آماده‌سازی است، اما می‌توانی صفحه‌ی [کارت‌های مهارت‌های زندگی؛ ذهن‌آگاهی](/products/mindfulness-skills-cards) را ببینی.

اگر فعلاً می‌خواهی فقط روی یکی از مهارت‌های اصلی DBT تمرکز کنی، مقاله [ذهن‌آگاهی چیست؟](/blog/what-is-mindfulness) از مفهوم، کاربرد روزمره و چند تمرین ساده شروع می‌کند.
